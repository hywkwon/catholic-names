...
- male_honorific: "○○ 형제님" 형태. 예) 마르코 형제님, 가브리엘 형제님
- female_honorific: 해당 성인의 여성형 이름이 있으면 그것으로 표시. 예) 마르코→마르첼라 자매님, 요한→요한나 자매님, 베드로→페트로닐라 자매님, 바오로→바울리나 자매님, 프란치스코→프란치스카 자매님, 가브리엘→가브리엘라 자매님, 미카엘→미카엘라 자매님. 여성형이 없는 남성 전용 성인이면 "(남성 전용 세례명)" 으로 표시.
- 절대 '성(聖)' 접두어 붙이지 말 것.`;
