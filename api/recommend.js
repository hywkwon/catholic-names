...
- ${isFemale ? '여성이므로 여성 성인 우선 추천 (마리아,루치아,체칠리아,아녜스,데레사,소피아,젬마,막달레나,발부르가,앙젤리카 등). 유니크(드묾)=젬마,발부르가,앙젤리카,아델라이다,이르미나,빅토리나,콜롬바. 인기=마리아,데레사,루치아,소피아,체칠리아,클라라,엘리사벳' : '남성이므로 남성 성인 우선 추천 (요한,베드로,바오로,미카엘,가브리엘,프란치스코,다윗,요셉 등). 유니크(드묾)=다미아노,막시밀리아노,아드리아노,힐라리오,에우게니오,보나벤투라,콘라도. 인기=프란치스코,가브리엘,다윗,미카엘,타대오,요셉,베드로'}
